...
const productImages = {
  ...
  // Shoes (30 products)
  "shoe-white-sneaker.svg": ["White Sneakers", "#e3f2fd", "#90caf9"],
  "shoe-pointed-heels.svg": ["Pointed Heels", "#212121", "#616161"],
  "shoe-platform-sandal.svg": ["Platform Sandals", "#e0f2f1", "#80cbc4"],
  "shoe-chelsea-boot.svg": ["Chelsea Boots", "#3e2723", "#5d4037"],
  "shoe-mules.svg": ["Slip-On Mules", "#efebe9", "#a1887f"],
  "shoe-strappy-block.svg": ["Strappy Block Heels", "#fce4ec", "#f06292"],
  "shoe-canvas-flat.svg": ["Canvas Flats", "#e3f2fd", "#64b5f6"],
  "shoe-knee-high.svg": ["Knee-High Boots", "#3e2723", "#4e342e"],
  "shoe-embellished-flat.svg": ["Embellished Flats", "#fff8e1", "#ffd54f"],
  "shoe-running.svg": ["Running Trainers", "#e8eaf6", "#7986cb"],
  "shoe-furry-slide.svg": ["Furry Slides", "#fce4ec", "#f8bbd0"],
  "shoe-clear-mule.svg": ["Clear Mules", "#e0f7fa", "#80deea"],
  "shoe-combat-boot.svg": ["Combat Boots", "#212121", "#424242"],
  "shoe-ballet-flat.svg": ["Ballet Flats", "#fce4ec", "#f48fb1"],
  "shoe-espadrille.svg": ["Espadrille Wedges", "#efebe9", "#d7ccc8"],
  "shoe-quilted-loafer.svg": ["Quilted Loafers", "#212121", "#424242"],
  "shoe-chunky-sneaker.svg": ["Chunky Sneakers", "#e3f2fd", "#90caf9"],
  "shoe-kitten-heel.svg": ["Kitten Heels", "#fce4ec", "#ec407a"],
  "shoe-braided-sandal.svg": ["Braided Sandals", "#efebe9", "#a1887f"],
  "shoe-rhinestone-heel.svg": ["Rhinestone Heels", "#fff8e1", "#ffd54f"],
  "shoe-mesh-ballet.svg": ["Mesh Ballet Sneakers", "#e3f2fd", "#64b5f6"],
  "shoe-cowboy-boot.svg": ["Cowboy Boots", "#efebe9", "#8d6e63"],
  "shoe-jelly-sandal.svg": ["Jelly Sandals", "#fce4ec", "#f48fb1"],
  "shoe-satin-flat.svg": ["Satin Flats", "#fce4ec", "#f8bbd0"],
  "shoe-sock-bootie.svg": ["Sock Booties", "#212121", "#616161"],
  "shoe-cloud-slide.svg": ["Cloud Slides", "#e3f2fd", "#bbdefb"],
  "shoe-oxford.svg": ["Oxford Shoes", "#3e2723", "#5d4037"],
  "shoe-ankle-stiletto.svg": ["Ankle Stilettos", "#fce4ec", "#ec407a"],
  "shoe-woven-mule.svg": ["Woven Mules", "#efebe9", "#bcaaa4"],
  "shoe-platform-hightop.svg": ["Platform High-Tops", "#e3f2fd", "#90caf9"],

  // Clothes (30 products)
  "cloth-graphic-tee.svg": ["Graphic Tee", "#f3e5f5", "#ce93d8"],
  "cloth-wide-jeans.svg": ["Wide Leg Jeans", "#e3f2fd", "#64b5f6"],
  "cloth-satin-dress.svg": ["Satin Dress", "#fce4ec", "#f06292"],
  "cloth-cropped-hoodie.svg": ["Cropped Hoodie", "#ede7f6", "#b39ddb"],
  "cloth-pleated-skirt.svg": ["Pleated Skirt", "#fce4ec", "#f48fb1"],
  "cloth-blazer.svg": ["Blazer", "#212121", "#616161"],
  "cloth-bodysuit.svg": ["Bodysuit", "#efebe9", "#a1887f"],
  "cloth-cargo-pants.svg": ["Cargo Pants", "#e8f5e9", "#81c784"],
  "cloth-wrap-maxi.svg": ["Wrap Maxi Dress", "#fce4ec", "#ec407a"],
  "cloth-cardigan.svg": ["Knit Cardigan", "#efebe9", "#d7ccc8"],
  "cloth-bike-shorts.svg": ["Bike Shorts", "#212121", "#424242"],
  "cloth-puff-blouse.svg": ["Puff Blouse", "#e3f2fd", "#90caf9"],
  "cloth-lounge-set.svg": ["Lounge Set", "#ede7f6", "#b39ddb"],
  "cloth-denim-skirt.svg": ["Denim Skirt", "#e3f2fd", "#64b5f6"],
  "cloth-tube-top.svg": ["Tube Top 3-Pack", "#fce4ec", "#f48fb1"],
  "cloth-floral-sundress.svg": ["Floral Sundress", "#fce4ec", "#f06292"],
  "cloth-crop-tank.svg": ["Crop Tank", "#f3e5f5", "#ce93d8"],
  "cloth-trench-coat.svg": ["Trench Coat", "#efebe9", "#a1887f"],
  "cloth-yoga-leggings.svg": ["Yoga Leggings", "#212121", "#616161"],
  "cloth-linen-pants.svg": ["Linen Pants", "#efebe9", "#d7ccc8"],
  "cloth-bodycon-dress.svg": ["Bodycon Dress", "#fce4ec", "#ec407a"],
  "cloth-denim-jacket.svg": ["Denim Jacket", "#e3f2fd", "#64b5f6"],
  "cloth-smocked-crop.svg": ["Smocked Crop Top", "#fce4ec", "#f48fb1"],
  "cloth-tailored-shorts.svg": ["Tailored Shorts", "#efebe9", "#a1887f"],
  "cloth-satin-shirt.svg": ["Satin Shirt", "#fce4ec", "#f8bbd0"],
  "cloth-joggers.svg": ["Joggers", "#ede7f6", "#9575cd"],
  "cloth-corset-top.svg": ["Corset Top", "#fce4ec", "#ec407a"],
  "cloth-jumpsuit.svg": ["Jumpsuit", "#212121", "#424242"],
  "cloth-mesh-top.svg": ["Mesh Top", "#f3e5f5", "#ba68c8"],
  "cloth-skirt-set.svg": ["Skirt Set", "#fce4ec", "#f06292"],

  // Luxury Clothes (Macy's inspired)
  "lux-ruched-dress.svg": ["Ruched Midi Dress", "#4a148c", "#7b1fa2"],
  "lux-sequin-gown.svg": ["Sequin Gown", "#212121", "#ffd54f"],
  "lux-chiffon-maxi.svg": ["Chiffon Maxi", "#f3e5f5", "#ce93d8"],
  "lux-velvet-wrap.svg": ["Velvet Wrap Dress", "#4a148c", "#7b1fa2"],
  "lux-lace-flare.svg": ["Lace Fit & Flare", "#fce4ec", "#f06292"],
  "lux-silk-cami.svg": ["Silk Camisole", "#fce4ec", "#f8bbd0"],
  "lux-bow-blouse.svg": ["Bow Blouse", "#e8eaf6", "#9fa8da"],
  "lux-cashmere-turtle.svg": ["Cashmere Turtleneck", "#efebe9", "#a1887f"],
  "lux-cape-blouse.svg": ["Cape Blouse", "#212121", "#616161"],
  "lux-ruffle-top.svg": ["Ruffle Top", "#fce4ec", "#f48fb1"],
  "lux-palazzo-pants.svg": ["Palazzo Pants", "#212121", "#424242"],
  "lux-leather-legging.svg": ["Leather Leggings", "#212121", "#424242"],
  "lux-satin-skirt.svg": ["Satin Slip Skirt", "#fce4ec", "#f06292"],
  "lux-cigarette-pants.svg": ["Cigarette Pants", "#212121", "#616161"],
  "lux-tulle-skirt.svg": ["Tulle Skirt", "#f3e5f5", "#ba68c8"],
  "lux-wool-coat.svg": ["Wool Wrap Coat", "#efebe9", "#8d6e63"],
  "lux-teddy-jacket.svg": ["Teddy Jacket", "#efebe9", "#d7ccc8"],
  "lux-blazer-dress.svg": ["Blazer Dress", "#212121", "#424242"],
  "lux-puffer-vest.svg": ["Puffer Vest", "#e8eaf6", "#5c6bc0"],
  "lux-moto-jacket.svg": ["Moto Jacket", "#212121", "#424242"],
  "lux-power-suit.svg": ["Power Suit", "#212121", "#616161"],
  "lux-wide-jumpsuit.svg": ["Wide Jumpsuit", "#212121", "#424242"],
  "lux-knit-coord.svg": ["Knit Co-Ord Set", "#efebe9", "#bcaaa4"],
  "lux-beaded-dress.svg": ["Beaded Dress", "#212121", "#ffd54f"],
  "lux-draped-gown.svg": ["Draped Gown", "#212121", "#616161"],
  "lux-feather-dress.svg": ["Feather Dress", "#fce4ec", "#ec407a"],
  "lux-pajama-set.svg": ["Pajama Set", "#e8eaf6", "#c5cae9"],
  "lux-tweed-jacket.svg": ["Tweed Jacket", "#efebe9", "#a1887f"],
  "lux-draped-top.svg": ["Draped Top", "#efebe9", "#d7ccc8"],
  "lux-metallic-skirt.svg": ["Metallic Skirt", "#e8eaf6", "#9fa8da"],
  "lux-cable-dress.svg": ["Cable Knit Dress", "#efebe9", "#a1887f"],
  "lux-plunge-satin.svg": ["Plunge Satin Blouse", "#fce4ec", "#f06292"],
  "lux-organza-top.svg": ["Organza Top", "#f3e5f5", "#e1bee7"],
  "lux-paperbag-pants.svg": ["Paper Bag Pants", "#efebe9", "#bcaaa4"],
  "lux-rhinestone-body.svg": ["Rhinestone Bodysuit", "#212121", "#ffd54f"],
};
...
const categoryImages = {
  ...
  "shoes.svg": ["SHOES", "#0288d1", "#01579b"],
  "clothes.svg": ["CLOTHES", "#7b1fa2", "#4a148c"],
};

...
const productImages = {
  ...
  // Trending Makeup Products (SHEGLAM & Shein inspired)
  "color-bloom-blush.svg": ["Color Bloom Blush", "#fce4ec", "#ec407a"],
  "foundation-stick.svg": ["Foundation Stick", "#fbe9e7", "#ffab91"],
  "glass-lock-gloss.svg": ["Glass Lock Gloss", "#fce4ec", "#f48fb1"],
  "lip-plumper.svg": ["Lip Plumper", "#fce4ec", "#f06292"],
  "liquid-contour.svg": ["Liquid Contour", "#efebe9", "#a1887f"],
  "dynamatte-lipstick.svg": ["Dynamatte Lipstick", "#fce4ec", "#e91e63"],
  "creamsicle-shadow.svg": ["Creamsicle Shadow", "#f3e5f5", "#ce93d8"],
  "bouncy-highlighter.svg": ["Bouncy Highlighter", "#fff8e1", "#ffd54f"],
  "magic-concealer.svg": ["Magic Concealer", "#fff3e0", "#ffcc80"],
  "crystal-jelly.svg": ["Crystal Jelly", "#e8f5e9", "#a5d6a7"],
  "peel-lip-stain.svg": ["Peel Lip Stain", "#fce4ec", "#ec407a"],
  "lip-duo.svg": ["Lip Duo", "#fce4ec", "#f48fb1"],
  "freckle-tint.svg": ["Freckle Tint", "#efebe9", "#bcaaa4"],
  "body-glitter.svg": ["Body Glitter", "#f3e5f5", "#ce93d8"],
  "contour-duo.svg": ["Contour Duo", "#efebe9", "#8d6e63"],
  "clear-brow-gel.svg": ["Clear Brow Gel", "#efebe9", "#a1887f"],
  "lip-blur.svg": ["Lip Blur", "#fce4ec", "#f48fb1"],
  "cloudline-liner.svg": ["Cloudline Liner", "#fce4ec", "#e91e63"],
  "jelly-lip-oil.svg": ["Jelly Lip Oil", "#fce4ec", "#f06292"],
  "lunar-glow.svg": ["Lunar Glow", "#fff8e1", "#ffd54f"],

  // Trending Skincare Products (K-beauty & viral inspired)
  "snail-96-essence.svg": ["Snail 96% Essence", "#e0f2f1", "#b2dfdb"],
  "aha-bha-peel.svg": ["AHA BHA Peel", "#fce4ec", "#ef9a9a"],
  "zombie-mask.svg": ["Zombie Pack Mask", "#e8f5e9", "#81c784"],
  "bha-exfoliant.svg": ["BHA Exfoliant", "#f3e5f5", "#ba68c8"],
  "hydro-boost-gel.svg": ["Hydro Boost Gel", "#e0f7fa", "#4dd0e1"],
  "cica-barrier.svg": ["Cica Barrier Cream", "#e8f5e9", "#a5d6a7"],
  "healing-clay.svg": ["Healing Clay", "#efebe9", "#8d6e63"],
  "clean-balm.svg": ["Cleansing Balm", "#fce4ec", "#f8bbd0"],
  "pure-rosehip.svg": ["Pure Rosehip Oil", "#fff3e0", "#ffcc80"],
  "bio-repair-oil.svg": ["Bio Repair Oil", "#fff3e0", "#ffb74d"],
  "putty-primer.svg": ["Putty Primer", "#fbe9e7", "#ffab91"],
  "yerba-eye-gel.svg": ["Yerba Eye Gel", "#e8f5e9", "#81c784"],
  "cica-mask-pack.svg": ["Cica Mask Pack", "#e8f5e9", "#a5d6a7"],
  "blackhead-stick.svg": ["Blackhead Stick", "#efebe9", "#9e9e9e"],
  "neck-firming.svg": ["Neck Firming", "#fce4ec", "#f8bbd0"],

  // Trending Haircare Products
  "rosemary-biotin.svg": ["Rosemary Biotin", "#e8f5e9", "#81c784"],
  "collagen-treatment.svg": ["Collagen Treatment", "#ede7f6", "#b39ddb"],
  "silk-curling-set.svg": ["Silk Curling Set", "#fce4ec", "#f06292"],
  "extreme-edge.svg": ["Extreme Edge", "#e0f2f1", "#80cbc4"],
  "flyaway-stick.svg": ["Flyaway Stick", "#efebe9", "#a1887f"],
  "keratin-leave-in.svg": ["Keratin Leave-In", "#e8eaf6", "#9fa8da"],
  "sweat-dry-shampoo.svg": ["Dry Shampoo", "#e8eaf6", "#7986cb"],
  "scalp-brush.svg": ["Scalp Brush", "#f3e5f5", "#ba68c8"],
  "rice-water-spray.svg": ["Rice Water Spray", "#fff8e1", "#fff176"],
  "hair-oil-gloss.svg": ["Hair Oil Gloss", "#fff3e0", "#ffb74d"],

  // Trending Body Care Products
  "mighty-patches.svg": ["Mighty Patches", "#fce4ec", "#f8bbd0"],
  "drying-lotion.svg": ["Drying Lotion", "#fce4ec", "#f48fb1"],
  "solar-cuticle.svg": ["Cuticle Oil", "#fff3e0", "#ffcc80"],
  "dermaplane-razors.svg": ["Dermaplane Razors", "#e8eaf6", "#c5cae9"],
  "plumper-duo.svg": ["Lip Plumper Duo", "#fce4ec", "#f06292"],
  "wrist-bands.svg": ["Wrist Bands", "#e0f7fa", "#80deea"],
  "volcanic-roller.svg": ["Volcanic Roller", "#efebe9", "#9e9e9e"],
  "foot-peel.svg": ["Foot Peel Mask", "#e0f2f1", "#80cbc4"],
  "steel-foot-file.svg": ["Foot File", "#e8eaf6", "#9fa8da"],

  // Trending Accessories
  "ice-roller-facial.svg": ["Ice Roller", "#e0f7fa", "#4dd0e1"],
  "derma-roller.svg": ["Derma Roller", "#e8eaf6", "#c5cae9"],
  "lash-princess.svg": ["Lash Princess", "#fce4ec", "#ec407a"],
  "liner-stamp.svg": ["Liner Stamp", "#e8eaf6", "#5c6bc0"],
  "velour-puffs.svg": ["Velour Puffs", "#fce4ec", "#f48fb1"],
  "rewind-sponge.svg": ["Rewind Sponge", "#fff3e0", "#ffcc80"],

  // Watches (50 products)
  "watch-classic-gold.svg": ["Classic Gold Watch", "#fff8e1", "#ffc107"],
  "watch-rose-mesh.svg": ["Rose Gold Mesh", "#fce4ec", "#e91e63"],
  "watch-silver-crystal.svg": ["Silver Crystal Watch", "#e8eaf6", "#9fa8da"],
  "watch-white-leather.svg": ["White Leather Watch", "#f5f5f5", "#e0e0e0"],
  "watch-luxury-diamond.svg": ["Luxury Diamond Watch", "#fff8e1", "#ffd54f"],
  "watch-smart-fitness.svg": ["Smart Fitness Watch", "#e8eaf6", "#5c6bc0"],
  "watch-vintage-floral.svg": ["Vintage Floral Watch", "#fce4ec", "#f48fb1"],
  "watch-ceramic-white.svg": ["Ceramic White Watch", "#f5f5f5", "#bdbdbd"],
  "watch-black-digital.svg": ["Black Digital Watch", "#424242", "#757575"],
  "watch-chain-link.svg": ["Chain Link Watch", "#fff8e1", "#ffc107"],
  "watch-starry-sky.svg": ["Starry Sky Watch", "#e8eaf6", "#7986cb"],
  "watch-pearl.svg": ["Pearl Watch", "#fce4ec", "#f8bbd0"],
  "watch-marble.svg": ["Marble Dial Watch", "#f5f5f5", "#bdbdbd"],
  "watch-bangle.svg": ["Bangle Watch", "#fff8e1", "#ffc107"],
  "watch-square-vintage.svg": ["Square Vintage Watch", "#efebe9", "#a1887f"],
  "watch-rainbow.svg": ["Rainbow Crystal Watch", "#f3e5f5", "#ce93d8"],
  "watch-dainty-rose.svg": ["Dainty Rose Watch", "#fce4ec", "#f06292"],
  "watch-chrono-sport.svg": ["Chronograph Sport", "#e8eaf6", "#5c6bc0"],
  "watch-butterfly.svg": ["Butterfly Watch", "#fff8e1", "#ffd54f"],
  "watch-dual-tone.svg": ["Dual-Tone Watch", "#fff8e1", "#c0ca33"],
  "watch-pastel-pink.svg": ["Pastel Pink Watch", "#fce4ec", "#f48fb1"],
  "watch-art-deco.svg": ["Art Deco Watch", "#fff8e1", "#ffc107"],
  "watch-solar.svg": ["Solar Eco Watch", "#e8f5e9", "#81c784"],
  "watch-boyfriend.svg": ["Boyfriend Watch", "#efebe9", "#8d6e63"],
  "watch-charm-set.svg": ["Charm Watch Set", "#fff8e1", "#ffd54f"],
  "watch-turquoise.svg": ["Turquoise Watch", "#e0f2f1", "#4db6ac"],
  "watch-tank-gold.svg": ["Tank Gold Watch", "#fff8e1", "#ffc107"],
  "watch-glitter.svg": ["Glitter Dial Watch", "#e8eaf6", "#9fa8da"],
  "watch-bamboo.svg": ["Bamboo Wood Watch", "#efebe9", "#a1887f"],
  "watch-multi-wrap.svg": ["Multi-Wrap Watch", "#efebe9", "#8d6e63"],
  "watch-moonphase.svg": ["Moonphase Watch", "#e8eaf6", "#7986cb"],
  "watch-resin-color.svg": ["Resin Color Watch", "#f3e5f5", "#ce93d8"],
  "watch-fob.svg": ["Nurse Fob Watch", "#e0f2f1", "#4db6ac"],
  "watch-layered-set.svg": ["Layered Watch Set", "#fff8e1", "#ffd54f"],
  "watch-sport-wp.svg": ["Sport Waterproof", "#e8eaf6", "#5c6bc0"],
  "watch-mop-dress.svg": ["MOP Dress Watch", "#fce4ec", "#f8bbd0"],
  "watch-zodiac.svg": ["Zodiac Watch", "#e8eaf6", "#7986cb"],
  "watch-mesh-set.svg": ["Mesh Band Set", "#fff8e1", "#ffc107"],
  "watch-black-gold.svg": ["Black Gold Watch", "#424242", "#ffc107"],
  "watch-stretch.svg": ["Stretch Band Watch", "#fff8e1", "#ffe082"],
  "watch-led-touch.svg": ["LED Touch Watch", "#424242", "#757575"],
  "watch-pocket-necklace.svg": ["Pocket Necklace", "#efebe9", "#a1887f"],
  "watch-nurse-silicone.svg": ["Nurse Silicone Watch", "#e0f2f1", "#80cbc4"],
  "watch-emerald.svg": ["Emerald Green Watch", "#e8f5e9", "#4caf50"],
  "watch-diamond-dress.svg": ["Diamond Dress Watch", "#fff8e1", "#ffd54f"],
  "watch-jelly.svg": ["Candy Jelly Watch", "#fce4ec", "#f48fb1"],
  "watch-3-pack.svg": ["Watch 3-Pack", "#efebe9", "#a1887f"],
  "watch-embroidered.svg": ["Embroidered Watch", "#fce4ec", "#f06292"],
  "watch-magnetic-ball.svg": ["Magnetic Ball Watch", "#e8eaf6", "#9fa8da"],
  "watch-crystal-healing.svg": ["Crystal Healing Watch", "#f3e5f5", "#ba68c8"],

  // Wigs (20 products)
  "wig-straight-lace.svg": ["Straight Lace Wig", "#efebe9", "#8d6e63"],
  "wig-body-wave.svg": ["Body Wave Wig", "#efebe9", "#a1887f"],
  "wig-short-bob.svg": ["Short Bob Wig", "#3e2723", "#5d4037"],
  "wig-deep-wave.svg": ["Deep Wave Wig", "#efebe9", "#6d4c41"],
  "wig-pixie.svg": ["Pixie Cut Wig", "#3e2723", "#4e342e"],
  "wig-water-wave.svg": ["Water Wave Wig", "#efebe9", "#8d6e63"],
  "wig-kinky-headband.svg": ["Kinky Headband Wig", "#3e2723", "#5d4037"],
  "wig-ombre-blonde.svg": ["Ombre Blonde Wig", "#efebe9", "#ffd54f"],
  "wig-braided-cornrow.svg": ["Braided Cornrow Wig", "#3e2723", "#4e342e"],
  "wig-ginger.svg": ["Ginger Wig", "#efebe9", "#e65100"],
  "wig-afro-coily.svg": ["Afro Coily Wig", "#3e2723", "#5d4037"],
  "wig-burgundy.svg": ["Burgundy Wig", "#4a148c", "#880e4f"],
  "wig-u-part.svg": ["U-Part Wig", "#efebe9", "#8d6e63"],
  "wig-613-blonde.svg": ["613 Blonde Wig", "#fff8e1", "#ffd54f"],
  "wig-twist-braids.svg": ["Twist Braids Wig", "#3e2723", "#5d4037"],
  "wig-highlight.svg": ["Highlight Wig", "#efebe9", "#ffc107"],
  "wig-curly-bob.svg": ["Curly Bob Wig", "#3e2723", "#6d4c41"],
  "wig-bone-straight.svg": ["Bone Straight Wig", "#212121", "#424242"],
  "wig-crochet-curly.svg": ["Crochet Curly Wig", "#3e2723", "#5d4037"],
  "wig-curtain-bangs.svg": ["Curtain Bangs Wig", "#efebe9", "#8d6e63"],
};
...
const categoryImages = {
  ...
  "watches.svg": ["WATCHES", "#ffc107", "#e65100"],
  "wigs.svg": ["WIGS", "#8d6e63", "#3e2723"],
};
